...
Today in lab you will create a new repository, and then copy the files in this folder into it. Once you're working in that new repo, create solutions to some code problems such that your solutions pass the included tests.
